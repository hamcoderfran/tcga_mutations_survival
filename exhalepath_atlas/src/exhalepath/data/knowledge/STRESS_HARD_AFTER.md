...
| comorbidity_weight_overflow | robustness | ✓ | major_depressive_disorder | 3.420 |
| comorbidity_weight_negative | robustness | ✓ | major_depressive_disorder | 3.060 |
| twenty_comorbidities | robustness | ✓ | major_depressive_disorder | 5.068 |
| gene_BRCA1_as_disease | gene_trap | ✓ | custom::brca1 | 0.167 |
...
| sz_suppress_acetone | clinical_hard | ✓ | schizophrenia | 3.652 |
| sz_heart_suppress_tma | clinical_hard | ✓ | schizophrenia | 4.396 |
